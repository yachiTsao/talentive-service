...
4. [POST /favorites/:id — 新增收藏](#4-post-favoritesid--新增收藏)
5. [DELETE /favorites/:id — 移除收藏](#5-delete-favoritesid--移除收藏)
6. [GET /favorites — 取得分群收藏清單](#6-get-favorites--取得分群收藏清單)
7. [GET /docs — API 文件頁面](#7-get-docs--api-文件頁面)
